...
/**
 * Vault-owned chat scope SQL — vault / vault_document / vault_container tables.
 *
 * Chat module delegates via {@see \\oaaoai\\chat\\ChatVaultScope} and {@code api('vault')->scopeForChat()}.
 */
final class VaultChatScope
{
    /**
     * @return list<int>
     */
