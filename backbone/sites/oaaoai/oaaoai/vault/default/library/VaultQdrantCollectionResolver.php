 ...
 * 2. Tenant slug (primed via {@see setTenantSlug} from core {@code tenantContextSlug}) + scope bucket:
...
final class VaultQdrantCollectionResolver
{
    ...
    public static function setTenantSlug(?string $slug): void
    {
        $s = $slug !== null ? trim($slug) : '';
        self::$tenantSlug = $s !== '' ? $s : null;
    }
     ...
     */
    public static function resolveEffectiveCollection(array $vaultRow, ?string $tenantSlug = null): ?string
    {
        ...
        $tenant = self::tenantSlug($tenantSlug);
    ...
    public static function tenantSlug(?string $override = null): string
    {
