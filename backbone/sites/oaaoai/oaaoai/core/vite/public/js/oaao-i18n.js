...
const OAAO_I18N_BASE = {
    en: {
        ...
        'chat.materials.filter_slides': 'Slides',
        'chat.materials.continue_deck': 'Continue this deck',
        'chat.materials.continuing_deck': 'Continuing: {title}',
        'chat.materials.clear_active': 'Stop continuing this deck',
        'chat.templates.slug_prefix': '/template',
        'chat.templates.slug_placeholder': 'template id or name',
        'chat.templates.slug_not_found': 'No published template matches that id or name.',
        'chat.templates.clear_active': 'Clear slide template',

        'chat.desk_mode.badge': 'Desk Mode',
        'chat.send_message': 'Send message',
        'chat.stop_generation': 'Stop generating',
        'chat.agent_ask.proceed': 'Run',
        'chat.agent_ask.proceed_same': 'Continue here',
    ...
    'zh-Hant': {
        ...
        'chat.materials.filter_slides': '簡報',
        'chat.materials.continue_deck': '繼續此簡報',
        'chat.materials.continuing_deck': '繼續編輯：{title}',
        'chat.materials.clear_active': '取消繼續此簡報',
        'chat.templates.slug_prefix': '/template',
        'chat.templates.slug_placeholder': '模板 id 或名稱',
        'chat.templates.slug_not_found': '找不到已發佈的模板（id 或名稱不符）。',
        'chat.templates.clear_active': '清除簡報模板',

        'chat.desk_mode.badge': 'Desk Mode',
        'chat.send_message': '傳送訊息',
        'chat.stop_generation': '停止產生',
        'chat.agent_ask.proceed': '執行',
        'chat.agent_ask.proceed_same': '在此對話繼續',
