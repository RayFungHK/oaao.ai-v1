...
const OAAO_I18N_BASE = {
    en: {
        ...
        'calendar.schedule_heading': 'Schedule',
        'calendar.schedule_empty': 'No upcoming events.',
        'calendar.form.date': 'Date',
        'calendar.form.time': 'Time',
        'calendar.form.notes_placeholder': 'Optional notes',
        'bubble_chat.open': 'Bubble Chat',
        'bubble_chat.title': 'Bubble Chat',
        'bubble_chat.hint': 'Short-lived chat — not saved to your sidebar. Session expires after inactivity.',
        'bubble_chat.placeholder': 'Ask a quick question…',
        'bubble_chat.send': 'Send',
        'bubble_chat.status_sending': 'Sending…',
        'bubble_chat.status_streaming': 'Thinking…',
        'bubble_chat.expired': 'Session expired — send again to start fresh.',
        'bubble_chat.burst': 'This bubble expired — close and reopen Bubble Chat, or send again to start fresh.',
        'bubble_chat.error_send': 'Could not send — try again.',
        'bubble_chat.error_unavailable': 'Bubble Chat unavailable',
        'bubble_chat.close': 'Close',
        'bubble_chat.error_dialog': 'Dialog unavailable',
        'productivity.todo.dialog_title_multi': 'Add to todos',
        'productivity.todo.add_multi_prompt': 'Add {count} todos?',
        'productivity.todo.add_all': 'Add selected',
        'todos.panel.title': 'Todos',
        'todos.filter.open': 'Open',
        'todos.filter.done': 'Done',
        'todos.filter.all': 'All',
        'todos.action.done': 'Done',
        'todos.action.reopen': 'Reopen',
        'library.action.delete': 'Delete',
        'library.delete.confirm': 'Delete this document? This cannot be undone.',
        'library.delete.confirm_title': 'Delete document?',
        ...
        'productivity.todo.resolved': 'Todo marked complete.',
        'productivity.todo.resolve_failed': 'Could not mark todo complete.',
        ...
        'productivity.common.loading': 'Working…',
        'productivity.strip.todos_added': 'Todos added.',
        'productivity.strip.calendar_added': 'Added to calendar.',
        'productivity.strip.confirmed': 'Done.',
    ...
    'zh-Hant': {
        ...
        'calendar.view.month': '月曆',
        'calendar.new_event': '新增活動',
        'calendar.schedule_heading': '行程',
        'calendar.schedule_empty': '沒有即將到來的活動。',
        'calendar.form.date': '日期',
        'calendar.form.time': '時間',
        'calendar.form.notes_placeholder': '選填備註',
        'bubble_chat.open': '泡泡對話',
        'bubble_chat.title': '泡泡對話',
        'bubble_chat.hint': '短期對話 — 不會出現在側欄；閒置一段時間後自動消失。',
        'bubble_chat.placeholder': '快速提問…',
        'bubble_chat.send': '傳送',
        'bubble_chat.status_sending': '傳送中…',
        'bubble_chat.status_streaming': '思考中…',
        'bubble_chat.expired': '工作階段已過期 — 再傳送一次即可重新開始。',
        'bubble_chat.burst': '泡泡已過期 — 請關閉後重新開啟泡泡對話，或直接再傳送以開始新對話。',
        'bubble_chat.error_send': '無法傳送 — 請再試一次。',
        'bubble_chat.error_unavailable': '無法開啟泡泡對話',
        'bubble_chat.close': '關閉',
        'bubble_chat.error_dialog': '無法開啟對話框',
        'productivity.todo.dialog_title_multi': '加入待辦',
        'productivity.todo.add_multi_prompt': '加入 {count} 項待辦？',
        'productivity.todo.add_all': '加入已選項目',
        'todos.panel.title': '待辦',
        'todos.filter.open': '進行中',
        'todos.filter.done': '已完成',
        'todos.filter.all': '全部',
        'todos.action.done': '完成',
        'todos.action.reopen': '重新開啟',
        'library.action.delete': '刪除',
        'library.delete.confirm': '確定刪除此文件？此操作無法復原。',
        'library.delete.confirm_title': '刪除文件？',
        ...
        'productivity.todo.resolved': '待辦已標記完成。',
        'productivity.todo.resolve_failed': '無法標記待辦完成。',
        'productivity.todo.open_panel': '開啟待辦',
        'productivity.dismiss': '略過',
        'productivity.common.cancel': '取消',
        'productivity.common.add': '加入',
        'productivity.common.loading': '處理中…',
        'productivity.strip.todos_added': '已加入待辦。',
        'productivity.strip.calendar_added': '已加入日曆。',
        'productivity.strip.confirmed': '已完成。',
