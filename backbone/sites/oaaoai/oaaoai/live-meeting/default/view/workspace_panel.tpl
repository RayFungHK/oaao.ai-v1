<section class="oaao-live-meeting-root flex flex-1 min-h-0 min-w-0 flex-col w-full bg-[var(--grid-paper)]" data-module="oaao-live-meeting">
    ...
    <div class="flex flex-1 min-h-0 flex-col gap-2 p-4 overflow-hidden">
        ...
        <div data-oaao-live-meeting="stats-wrap" class="hidden shrink-0 flex-col gap-0.5" aria-live="polite">
            <span class="text-xs font-medium fg-[var(--grid-ink-muted)]" data-i18n="live_meeting.stats.label">Retrieval</span>
