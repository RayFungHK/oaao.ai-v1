...
/** Assistant message thumbs-up ({@see chat-panel.js}). */
export const OAAO_RUI_ICON_THUMBS_UP = 'thumbs-up';

/** Assistant message thumbs-down ({@see chat-panel.js}). */
export const OAAO_RUI_ICON_THUMBS_DOWN = 'thumbs-down';
...
const OAAO_SVG_ICONS = {
    ...
    /** Library rail ({@see workspace.tpl}, {@see library.php}). */
    'file-text':
        '<path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z" /><path d="M14 2v4a2 2 0 0 0 2 2h4" /><path d="M10 9H8" /><path d="M16 13H8" /><path d="M16 17H8" />',
    /** Library editor tips ({@see library-panel.js}). */
    'circle-help':
    ...
    /** Lucide thumbs-up / thumbs-down ({@see https://lucide.dev/icons/thumbs-up}). */
    'thumbs-up':
...
/**
 * Message feedback thumbs — always Lucide SVG (never LineIcons {@code ri-thumbs-*-3}).
 *
 * @param {HTMLElement} host
 * @param {'up' | 'down'} which
 * @param {{ size?: number, strokeWidth?: number | string, class?: string }} [opts]
 * @returns {HTMLElement | null}
 */
export function mountFeedbackThumbIconSync(host, which, opts = {}) {
    const name = which === 'down' ? OAAO_RUI_ICON_THUMBS_DOWN : OAAO_RUI_ICON_THUMBS_UP;
    return mountRuiIconSync(host, name, opts);
}
