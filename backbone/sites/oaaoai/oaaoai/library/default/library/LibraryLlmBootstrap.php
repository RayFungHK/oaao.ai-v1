...
/**
 * Resolve chat LLM binding for Library editor AI actions (CS-2-S5).
 */
final class LibraryLlmBootstrap
{
    /**
     * @return array{purpose_key: string, base_url: string, model: string, api_key_env: string|null}|null
     */
    public static function resolveEditorLlm(Controller $controller): ?array
    {
