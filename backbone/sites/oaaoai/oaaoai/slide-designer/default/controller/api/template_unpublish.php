...
/**
 * POST /slide-designer/api/template_unpublish
 * Body: { template_id }
 */
return function (): void {
    ...
    $result = SlideOrchestrator::unpublishTemplate($chatApi, $templateId, $scopeCtx);
    if ($result === null) {
        http_response_code(503);
    ...
    echo json_encode([
        ...
        'message'   => $ok ? 'Template unpublished' : (string) ($result['error'] ?? 'unpublish_failed'),
