...
/**
 * POST /slide-designer/api/slide_regenerate
 * Body: { project_id, page, conversation_id, chat_endpoint_id?, regen_markdown?: bool }
 */
return function (): void {
    ...
    $regenMarkdown = ! isset($input['regen_markdown']) || $input['regen_markdown'] !== false;
    ...
    $result = SlideOrchestrator::regeneratePage($chatApi, 
        $projectId,
        $page,
        $cid,
        $uid,
    ...
    echo json_encode([
        ...
        'message' => $fatal
            ...
            : ($ok ? 'Slide regenerated' : 'Slide regenerated with validation warnings'),
        'data'    => $result,
