...
// --- Resolve SYSTEM_ROOT: filesystem root of the Razy install (index.php + sites/ + config here).
// Same directory where `.htaccess` usually lives when using Apache rewrites; absence of .htaccess does not change SYSTEM_ROOT.
