...
| 7 | 核心 app.py 過重（1384 行） | High | P1 | python-lead | 🟡 In progress | W5-S1 phase 1 — admin + health extracted; phase 2 in flight — `/v1/mine/*` + `/v1/research/*` moved to `routes/mine.py` + `routes/research.py`; app.py 1707→1540 LOC; remaining: slides/live/runs | [python/oaao_orchestrator/app.py](../python/oaao_orchestrator/app.py) |
