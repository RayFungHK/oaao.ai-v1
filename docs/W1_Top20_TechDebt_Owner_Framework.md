...
| 7 | 核心 app.py 過重（1384 行） | High | P1 | python-lead | 🟡 In progress | W5-S1 phase 1 — admin + health extracted; phase 2 — `/v1/mine/*` + `/v1/research/*` moved; phase 3 — `/v1/live/*` (incl. WS + SSE) moved to `routes/live.py`; app.py 1707→1416 LOC; remaining: slides/runs | [python/oaao_orchestrator/app.py](../python/oaao_orchestrator/app.py) |
